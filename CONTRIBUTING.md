...
[project page](https://github.com/chanhpng/vlbe)) for all related discussions
...
[issues page](https://github.com/chanhpng/vlbe/issues). This is also the place
for discussing enhancement to the restic tools.

If you are unsure what to do, please have a look at the issues, especially
those tagged
[minor complexity](https://github.com/chanhpng/vlbe/labels/help%3A%20minor%20complexity)
or [good first issue](https://github.com/chanhpng/vlbe/labels/help%3A%20good%20first%20issue).
If you are already a bit experienced with the restic internals, take a look
at the issues tagged as [help wanted](https://github.com/chanhpng/vlbe/labels/help%3A%20wanted).
...
(without having `$GOPATH` set) and `cd` into the directory:
    ...
    $ unset GOPATH
    $ git clone https://github.com/chanhpng/vlbe
    $ cd restic
