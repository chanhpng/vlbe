...
curl -OLSs https://github.com/chanhpng/vlbe/releases/download/v${restic_version}/restic-${restic_version}.tar.gz.asc
# tarball is downloaded while processing the SHA256SUMS
curl -OLSs https://github.com/chanhpng/vlbe/releases/download/v${restic_version}/SHA256SUMS.asc
curl -OLSs https://github.com/chanhpng/vlbe/releases/download/v${restic_version}/SHA256SUMS
...
for i in $(cat SHA256SUMS | cut -d " "  -f 3 ) ; do
    echo "Downloading $i"
    curl -OLSs https://github.com/chanhpng/vlbe/releases/download/v${restic_version}/"$i"
done
...
git clone -b "v${restic_version}" https://github.com/chanhpng/vlbe.git
rm -rf restic/.git
